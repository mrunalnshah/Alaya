...
class SplitGroups extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SplitGroups(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> defaultSplitMethod =
      GeneratedColumn<String>(
  ...
  @override
  SplitGroups createAlias(String alias) {
    return SplitGroups(attachedDatabase, alias);
  }
...
class SplitMembers extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SplitMembers(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  SplitMembers createAlias(String alias) {
    return SplitMembers(attachedDatabase, alias);
  }
...
class SplitExpenses extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SplitExpenses(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<int> settleByDateKey = GeneratedColumn<int>(
    'settle_by_date_key',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  @override
  SplitExpenses createAlias(String alias) {
    return SplitExpenses(attachedDatabase, alias);
  }
...
class SplitShares extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SplitShares(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  SplitShares createAlias(String alias) {
    return SplitShares(attachedDatabase, alias);
  }
...
class SplitSettlements extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  SplitSettlements(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  @override
  SplitSettlements createAlias(String alias) {
    return SplitSettlements(attachedDatabase, alias);
  }
...
class VSplitExpenses extends ViewInfo<VSplitExpenses, Never>
    implements HasResultSet {
  final String? _alias;
  @override
  final DatabaseAtV4 attachedDatabase;
...
class VSplitBalances extends ViewInfo<VSplitBalances, Never>
    implements HasResultSet {
  final String? _alias;
  @override
  final DatabaseAtV4 attachedDatabase;
  ...
  late final GeneratedColumn<int> oldestUnsettledDateKey = GeneratedColumn<int>(
...
class VSplitGroupBalances extends ViewInfo<VSplitGroupBalances, Never>
    implements HasResultSet {
  final String? _alias;
  @override
  final DatabaseAtV4 attachedDatabase;
...
class VSplitActivity extends ViewInfo<VSplitActivity, Never>
    implements HasResultSet {
  final String? _alias;
  @override
  final DatabaseAtV4 attachedDatabase;
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final SplitGroups splitGroups = SplitGroups(this);
  ...
  late final SplitMembers splitMembers = SplitMembers(this);
  ...
  late final SplitExpenses splitExpenses = SplitExpenses(this);
  late final SplitShares splitShares = SplitShares(this);
  ...
  late final SplitSettlements splitSettlements = SplitSettlements(this);
